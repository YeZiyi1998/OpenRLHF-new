...
EXP_NAME=Qwen_Critic_machine_96
...
DATA="/data2/rlhf/yzy/data/rm/critic_inference/train"
DATA2="/data2/rlhf/yzy/data/rm/critic_inference/test"
...
../../examples/batch_inference.py \
    ...
    --flash_attn \
    --max_new_tokens 64 \
    --input_template Human_Assistant \
