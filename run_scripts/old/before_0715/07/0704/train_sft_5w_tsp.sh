...
EXP_NAME=Qwen_SFT_0704_5w_tsp

MODEL="/data2/rlhf/lixs/open_models/Qwen2-7B-Instruct/" 
DATA="/data2/rlhf/yzy/data/rm_train/train_reason/train_guide"
EVAL_DATA="/data2/rlhf/yzy/data/rm_train/train_reason/test_guide"
