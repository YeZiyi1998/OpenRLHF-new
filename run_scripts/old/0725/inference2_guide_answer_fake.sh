...
EXP_NAME=Qwen_Critic_machine_$2

MODEL="/data2/rlhf/lixs/open_models/Qwen2-7B-Instruct/"
File_NAME="Qwen_Critic_machine.jsonl" 
DATA="/data2/rlhf/yzy/data/sub_data/pairwise_critic_inference2_guide_answer_fake/$2"

save_path="/data2/rlhf/yzy/OpenRLHF-new/outputs/inference/${EXP_NAME}_guide_answer_fake"
