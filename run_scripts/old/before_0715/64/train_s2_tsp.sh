...
EXP_NAME=Qwen_pairwise_qwen_s2_$2_continue_$1

#USE YOUR TOKEN: REMEMBER!!!
WANDB_TOKENS=a77607626908409e45afa2ca225cf179e9a316fc
wandb login --relogin $WANDB_TOKENS

data_path="/data2/rlhf/yzy/data/rm/pairwise_critic_train_guide_qwen_300k/2"
# add_data="/data2/rlhf/yzy/tool/tgi/outputs/pairwise_critic.jsonl.4T85_sft"
add_data="/data2/rlhf/yzy/OpenRLHF-new/outputs/inference/Qwen_pairwise_qwen_s2_c_64/Qwen_Critic_machine.$1.jsonl"
...
hostfile="/data2/rlhf/yzy/OpenRLHF-new/run_scripts/0625/hostfile_$2"
