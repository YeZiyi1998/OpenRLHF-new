...
MODEL="/data2/rlhf/yzy/OpenRLHF-new/outputs/reward_models/Qwen_pairwise_qwen_s2_c_64/checkpoints/global_step3000/c"
# MODEL="/data2/rlhf/lixs/open_models/Qwen2-7B-Instruct/"
File_NAME="Qwen_Critic_machine.3000.test.jsonl" 
...
DATA="/data2/rlhf/yzy/data/rm/pairwise_critic_train/test"
