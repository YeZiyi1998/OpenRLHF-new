...
data_path="/data2/rlhf/yzy/data/hack_data/length_hack/数学计算"

EXP_NAME=length_hack1+length_hack_critic1_数学计算_merge_test_$1
model_path="/data2/rlhf/yzy/OpenRLHF-new/outputs/reward_models/length_hack1+length_hack_critic1_数学计算_merge_94"
