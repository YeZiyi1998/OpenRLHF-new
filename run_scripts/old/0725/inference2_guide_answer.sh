...
DATA="/data2/rlhf/yzy/data/sub_data/pairwise_critic_inference2_guide_answer/$2"

save_path="/data2/rlhf/yzy/OpenRLHF-new/outputs/inference/${EXP_NAME}_guide_answer"
