...
EXP_NAME=16B_MOE_RM_0606
# model_path="/data2/rlhf/lixs/open_models/DeepSeek-V2-Lite-Chat"
model_path="/eb_data/rlhf/yezy/open_models/DeepSeek-V2-Lite-Chat"
BATCH_SIZE_PER_GPU=1
LR=9e-6

#/eb_data
save_path="/eb_data/rlhf/yezy/OpenRLHF-new/outputs/reward_models/$EXP_NAME"
...
deepspeed --hostfile=$hostfile $training_commands 2>&1 | tee $save_path/train_test.log
