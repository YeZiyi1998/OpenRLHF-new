...
def train(args):
    ...
    # configure optimizer
    optim = strategy.create_optimizer2([model, model2, critic_model], lr=args.learning_rate, betas=(0.9, 0.95), weight_decay=args.l2)
    ...
    if model2 is not None:
        (model2, optim, scheduler) = strategy.prepare((model2, optim, scheduler))
