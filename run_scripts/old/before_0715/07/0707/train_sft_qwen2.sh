...
# python /data2/rlhf/yzy/write_email.py --info Qwen_RM_critic_tsp_machine

# #USE YOUR TOKEN: REMEMBER!!!
# WANDB_TOKENS=a77607626908409e45afa2ca225cf179e9a316fc
# wandb login --relogin $WANDB_TOKENS

# data_path="/data2/rlhf/yzy/data/rm/critic_train_rm_machine"

# EXP_NAME=Qwen_RM_critic_tsp_machine
...
# python /data2/rlhf/yzy/write_email.py --info Qwen_RM_critic_tsp_machine_done

set -x 
unset https_proxy
unset http_proxy
export PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:512
python /data2/rlhf/yzy/write_email.py --info Qwen_RM_critic_tsp_human
...
EXP_NAME=Qwen_RM_critic_tsp_human
# model_path="/data2/rlhf/lixs/open_models/DeepSeek-V2-Lite-Chat"
model_path="/data2/rlhf/lixs/open_models/Qwen2-7B-Instruct/"
BATCH_SIZE_PER_GPU=16
LR=9e-6
...
deepspeed --hostfile=$hostfile $training_commands 2>&1 | tee $save_path/train_qwen.log
python /data2/rlhf/yzy/write_email.py --info Qwen_RM_critic_tsp_human_done
